...
4. [Error Handling](references/_sections.md#4-error-handling) — **HIGH**
   ...
   - 4.4 [Use Zod 4 Error Formatting Helpers](references/error-use-flatten.md) — HIGH (Raw ZodError.issues requires manual path parsing; flatten() provides field-keyed errors ready for form display)
...
5. [Object Schemas](references/_sections.md#5-object-schemas) — **MEDIUM-HIGH**
   - 5.1 [Choose an Explicit Unknown-Key Policy](references/object-strict-vs-strip.md) — MEDIUM-HIGH
   - 5.2 [Distinguish optional() from nullable()](references/object-optional-vs-nullable.md) — MEDIUM-HIGH
   - 5.3 [Use Discriminated Unions for Type Narrowing](references/object-discriminated-unions.md) — MEDIUM-HIGH
   - 5.4 [Use extend() for Adding Fields](references/object-extend-for-composition.md) — MEDIUM-HIGH
   - 5.5 [Use partial() for Update Schemas](references/object-partial-for-updates.md) — MEDIUM-HIGH
   - 5.6 [Use pick() and omit() for Schema Variants](references/object-pick-omit.md) — MEDIUM-HIGH
...
8. [Performance & Bundle](references/_sections.md#8-performance-&-bundle) — **LOW-MEDIUM**
   ...
   - 8.3 [Lazy Load Large Schemas](references/perf-lazy-loading.md) — LOW-MEDIUM
   - 8.4 [Optimize Large Array Validation](references/perf-arrays.md) — LOW-MEDIUM
   - 8.5 [Use Zod Mini for Bundle-Sensitive Applications](references/perf-zod-mini.md) — LOW-MEDIUM
...
6. [https://zod.dev/error-formatting](https://zod.dev/error-formatting)
