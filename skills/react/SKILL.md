...
1. [Concurrent Rendering](references/_sections.md#1-concurrent-rendering) — **CRITICAL**
   ...
   - 1.2 [Leverage Automatic Batching for Fewer Renders](references/conc-automatic-batching.md) — HIGH (fewer renders in heavy updates)
...
2. [Server Components](references/_sections.md#2-server-components) — **CRITICAL**
   ...
   - 2.3 [Fetch Data in Server Components](references/rsc-data-fetching-server.md) — CRITICAL (less client JS, no client waterfalls)
...
3. [Actions & Forms](references/_sections.md#3-actions-&-forms) — **HIGH**
   ...
   - 3.3 [Use useFormStatus for Submit Button State](references/form-use-form-status.md) — MEDIUM-HIGH
...
4. [Data Fetching](references/_sections.md#4-data-fetching) — **HIGH**
   - 4.1 [Fetch Data in Parallel with Promise.all](references/data-parallel-fetching.md) — MEDIUM-HIGH
...
5. [State Management](references/_sections.md#5-state-management) — **MEDIUM-HIGH**
   ...
   - 5.3 [Use Functional State Updates for Derived Values](references/rstate-functional-updates.md) — MEDIUM-HIGH
   - 5.4 [Use Lazy Initialization for Expensive Initial State](references/rstate-lazy-initialization.md) — MEDIUM-HIGH
